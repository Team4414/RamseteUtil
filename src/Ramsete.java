...
public abstract class Ramsete {
    ...
    private static final double kZeta = 0.5;
     ...
     * </p>
     */
    private class DifferentiableRobotPos {
    ...
    private DifferentiableRobotPos mGoal;
    ...
    public void update(){
        ...
        mAngleError = mGoal.getPos().getHeading() - mPos.getHeading();

        //Constant Equation from teh paper.
        mConstant = 2.0 * kZeta *
